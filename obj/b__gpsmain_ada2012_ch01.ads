...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_gpsmain_ada2012_ch01" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#c2f7c7e7#;
   pragma Export (C, u00001, "gpsmain_ada2012_ch01B");
